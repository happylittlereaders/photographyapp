...
def show_guide_dialog(guide_name):
    ...
    if guide_name == "Rule of Thirds":
        ...
        w, h = vb_w, vb_h
        svg_overlay = f"""
            <line x1="{w*0.618}" y1="0" x2="{w*0.618}" y2="{h}" stroke="#dcc86f" stroke-width="1.5" stroke-dasharray="4,4" opacity="0.85" />
            <line x1="{w*0.618}" y1="{h*0.618}" x2="{w}" y2="{h*0.618}" stroke="#dcc86f" stroke-width="1.5" stroke-dasharray="4,4" opacity="0.85" />
            <line x1="{w*0.764}" y1="{h*0.618}" x2="{w*0.764}" y2="{h}" stroke="#dcc86f" stroke-width="1.5" stroke-dasharray="4,4" opacity="0.85" />
            <line x1="{w*0.618}" y1="{h*0.764}" x2="{w*0.764}" y2="{h*0.764}" stroke="#dcc86f" stroke-width="1.5" stroke-dasharray="4,4" opacity="0.85" />
            <line x1="{w*0.708}" y1="{h*0.618}" x2="{w*0.708}" y2="{h*0.764}" stroke="#dcc86f" stroke-width="1.5" stroke-dasharray="4,4" opacity="0.85" />
            ...
            <circle cx="{w*0.725}" cy="{h*0.72}" r="8" fill="#dcc86f" />
        """
